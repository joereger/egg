...
#            #Uninstall OpenJDK
#            ./log.sh "Uninstalling OpenJDK"
#            openjdkuninstall=`</dev/null ssh -n -t -t $HOST "sudo yum -y remove java-1.6.0-openjdk.i686"`
#            echo $openjdkuninstall
#            ./log.sh "Done uninstalling OpenJDK"
#
#            #Install Sun Java
#            ./log.sh "Install Sun Java"
#            openjdkuninstall=`</dev/null ssh -n -t -t $HOST "sudo yum -y remove java-1.6.0-openjdk.i686"`
#            echo $openjdkuninstall
